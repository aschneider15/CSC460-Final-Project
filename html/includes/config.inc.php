...
define('EMAIL', 'aidan.schneider@cuw.edu');

// Site URL (base for all redirections):
define('BASE_URL', 'http://localhost/Final%20Project/html/');

// Location of the MySQL connection script:
define('MYSQL', 'Final Project\mysqli_connect.php');
...
// A function to quickly log information to console:
